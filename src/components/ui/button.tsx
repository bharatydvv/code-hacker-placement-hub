...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-r from-primary to-secondary text-primary-foreground shadow-lg hover:shadow-primary/40 hover:scale-[1.02]',
        outline:
          'border border-white/15 bg-white/5 backdrop-blur hover:bg-white/10 hover:border-white/25',
        ghost: 'hover:bg-white/10',
        accent: 'bg-accent text-accent-foreground hover:opacity-90 glow-accent',
